...
(function() {
  (function($) {
    ...
    $.fn.assignHtml = function(options) {
      var html, i, item, itemClasses, _i, _len;
      itemClasses = ['jctdn-days', 'jctdn-hours', 'jctdn-mins', 'jctdn-secs'];
      html = '';
      for (i = _i = 0, _len = itemClasses.length; _i < _len; i = ++_i) {
        item = itemClasses[i];
        html += "<span class='" + item + "'><label>" + options.itemLabels[i] + "</label><div></div></span>";
      }
      return this.html(html);
    };
    return $.fn.updateCountdown = function(options) {
      var days, diff, hours, mins, now, parsed_date, secs, target,
        _this = this;
      now = new Date();
      ...
      if (diff <= 0) {
        ...
        $.data(this, 'timer', setTimeout((function() {
          return _this.updateCountdown(options);
        }), 1000));
      }
      this.find("span.jctdn-days div").html(days);
      this.find("span.jctdn-hours div").html(hours > 9 ? hours : '0' + hours);
      this.find("span.jctdn-mins div").html(mins > 9 ? mins : '0' + mins);
      return this.find("span.jctdn-secs div").html(secs > 9 ? secs : '0' + secs);
    };
  })(jQuery);
